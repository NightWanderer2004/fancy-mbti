   ...
   return (
      <>
         ...
         <div className='pt-24 relative z-40 animate-fadeUp max-w-2xl mx-auto'>
            ...
            />
            <Glow
               className='top-[860px] lg:top-[920px] -right-[100px] lg:-right-[800px] opacity-35 scale-[2000%] lg:scale-[1400%]'
               style={{ backgroundColor: color }}
            />
            <Glow
               className='top-[2060px] -left-[140px] lg:-left-[550px] opacity-35 scale-[1700%] lg:scale-[1220%]'
               style={{ backgroundColor: color }}
            />
            <Glow className='lg:hidden -bottom-[120px] right-[60px] opacity-35 scale-[2200%] lg:scale-[1220%]' style={{ backgroundColor: color }} />
            ...
            <div className='flex flex-col gap-3'>
               {Object.keys(info)
                  .slice(4)
                  .map((item, index) => (
                     <TypeSection key={index} heading={headers[item]} content={info[item]} type={type} color={color} />
                  ))}
            </div>
         </div>
      </>
