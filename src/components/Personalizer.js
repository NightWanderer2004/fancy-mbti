...
export default function Personalizer({ setResponse, setIsLoading, isLoading }) {
   ...
   const handleSubmit = async e => {
      ...
      const generateText = async () => {
         const prompt = `I need you to uncover and analyze my potential, considering such data as: my MBTI personality type, my hobbies and interests, profession, languages I master, and my age. Please elaborate on what will be useful for my development, and how I can feel comfort and harmony. Indicate the areas I should avoid and why they may harm me. Shed light on the most hidden corners of my personality and show where I can apply my strengths in the real world to achieve happiness. I want your answer to fill me with energy, confidence and let me understand what is really important for my inner peace. Also, try to identify certain problems that may be inherent to me, and tell me how to solve them. Give the answer in '.md' format. Please respond in the language in which the input data is written, not only English. And please, do not write an h1 title in the answer, only add heading to subtopics. In situation if data is not about personality and trying to tell you a personal information, please responde ONLY THIS - <h2>I need correct information! </h1>
